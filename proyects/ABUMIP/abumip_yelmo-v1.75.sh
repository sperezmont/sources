# ABUMIP experiments with Yelmo v1.75
# Aim: 3 standard experiments plus abuk-marine for exploring the difference in treatment of the boundary conditions
file_restart=/home/sergio/entra/ice_data/restart/alexr-yelmo_ismip6/spinup_32km_68/0/yelmo_restart.nc

fldr=output/ismip6/abumip_yelmo-v1.75/
