...
if [ ${stored_spinup} -eq 1 ]; then
floating_restart=${yelmox_path}/output/ismip6/d03_LateralBC/dtt_03/spinup_dtt_03_f/yelmo_restart.nc
marine_restart=${yelmox_path}/output/ismip6/d03_LateralBC/dtt_03/spinup_dtt_03_m/yelmo_restart.nc
else
...
if [ ${stored_spinup} -eq 1 ]; then
floating_restart=${yelmox_path}/output/ismip6/d03_LateralBC/dtt_03/spinup_dtt_03_fd${i}/yelmo_restart.nc
marine_restart=${yelmox_path}/output/ismip6/d03_LateralBC/dtt_03/spinup_dtt_03_md${i}/yelmo_restart.nc
else
